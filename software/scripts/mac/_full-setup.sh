...
################################################################################
# Only switch shell if current shell is not bash at all (e.g. zsh)
# Prefer Homebrew bash (5.x) over macOS system bash (3.2) for bind -x support
case "$SHELL" in
*/bash) echo ">> Default shell already set to bash: $SHELL" ;;
*)
