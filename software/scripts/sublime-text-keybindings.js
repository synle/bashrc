...
async function doWork() {
  ...
  if (DEBUG_WRITE_TO_DIR) {
    ...
    // non -mac keybinding
    writeJson('sublime_keybindings_windows', _formatKey([...COMMON_KEY_BINDINGS, ...WINDOWS_ONLY_KEY_BINDINGS], 'alt'));
    writeJson('sublime_keybindings_macosx', _formatKey([...COMMON_KEY_BINDINGS, ...MAC_ONLY_KEY_BINDINGS], 'super'));
