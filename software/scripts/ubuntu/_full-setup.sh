...
_waitForAptLock
if ((IS_CI)) || is_bash_syle_stale; then updatePackageIndex; else echo ">> Updating package index >> Skipped (not stale)"; fi
...
installAptPackage shellcheck # used by `make ci_test_shellcheck`
