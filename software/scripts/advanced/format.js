/** Code formatting and cleanup utilities for the workspace. */
// ============================================================
// Constants — used across all format functions
// ============================================================

/** Max find depth for light cleanup (from EDITOR_CONFIGS.maxNestedDepth) */
const MAX_DEPTH_CLEANUP = EDITOR_CONFIGS.maxNestedDepth;
...
`.trim();
  ...
  await writeBuildArtifact([{ file: `${BUILD_DIR}/format.sh`, data: formatScriptBlock }]);
}
