...
# Invoke-WebRequest -Uri "https://raw.githubusercontent.com/synle/bashrc/master/.build/windows-powershell-profile.ps1.bash" -OutFile "Microsoft.PowerShell_profile.ps1"
#
