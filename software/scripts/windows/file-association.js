/** Configures Windows default file associations for Sublime Text and VLC. */
...
const sevenZipProgramBinaryName = "7Zip";
...
async function doWork() {
  ...
  const imageExtensions = await readSet`software/metadata/file-association.image.config`;
  ...
  await writeBuildArtifact([
    {
      file: `${BUILD_DIR}/file-association-windows.ps1`,
    ...
    {
      file: `${BUILD_DIR}/file-association-windows-revert.ps1`,
      data: revertContent,
      comments: `
