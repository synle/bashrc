/** Installs and configures developer fonts (Fira Code, JetBrains Mono, etc). */
...
async function doWork() {
  ...
  const targetFontPath = await getCustomTweaksPath("fonts");
  ...
  if (isForceRefreshStale(targetFontPath)) {
