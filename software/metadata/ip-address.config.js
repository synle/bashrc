...
async function doWork() {
  ...
  await writeText(targetPath + ".hostnamesGroupedByID", HOSTNAMES_GROUPED_BY_ID);
  await writeText(targetPath + ".hostnamesFlattened", JSON.stringify(HOSTNAMES_FLATTENED, null, 2));
  await writeText(targetPath + ".etcHostnamesMappings", HOSTNAMES_MAPPINGS);
}
