 ...
 * @returns {void}
 */
declare function writeToBuildFile(tasks: Array<{
    file: string;
    data: any;
    isJson?: boolean;
    comments?: string;
 ...
 */
declare function updateTextBlock(content: string, key: string, sourceContent: string, commentPrefix: string, commentSuffix?: string, insertMode?: "append" | "prepend" | null, cleanupSpace?: boolean): string;
/**
 ...
 * @returns {string} The modified text content
 */
declare function appendTextBlock(content: string, key: string, sourceContent: string, commentPrefix?: string): string;
/**
 ...
 * @returns {string} The modified text content
 */
declare function prependTextBlock(content: string, key: string, sourceContent: string, commentPrefix?: string): string;
/**
 ...
 */
declare function registerProfileBlock({ profilePath, configKey, content, isPrepend, addCodeFolding }: {
    profilePath: string;
    configKey: string;
    content: string;
    isPrepend?: boolean;
...
/** @type {boolean} Windows (WSL /mnt/c detected) */ declare const is_os_windows: boolean;
