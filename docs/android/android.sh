...
#
# Debloat:
# curl -fsSL https://raw.githubusercontent.com/synle/bashrc/refs/heads/master/docs/android/android.sh https://raw.githubusercontent.com/synle/bashrc/refs/heads/master/docs/android/android.debloat.sh | sh
#
# Restore:
# curl -fsSL https://raw.githubusercontent.com/synle/bashrc/refs/heads/master/docs/android/android.sh https://raw.githubusercontent.com/synle/bashrc/refs/heads/master/docs/android/android.restore.sh | sh
#
# Settings
...
debloat_settings() {
  ...
  put_setting secure long_press_timeout 250         # Faster long press. May accidentally trigger long press when tap-and-scrolling.
  put_setting secure multi_press_timeout 250        # Tighter double/triple press window. Slow double-taps won't register.
