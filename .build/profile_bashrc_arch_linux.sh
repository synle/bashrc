...
# Generated: 2026-04-14T15:43:25.290Z
...
# same as __to_opts but deduplicates and sorts first
function __to_opts_sorted() { sort -u | tr '\n' ' '; }
# tab-completion handler for journalctl — resolves spec data, expands
# dynamic tokens (git branches, files, npm scripts, etc.), and populates COMPREPLY
...
# same as __to_opts but deduplicates and sorts first
function __to_opts_sorted() { sort -u | tr '\n' ' '; }
# tab-completion handler for systemctl — resolves spec data, expands
# dynamic tokens (git branches, files, npm scripts, etc.), and populates COMPREPLY
